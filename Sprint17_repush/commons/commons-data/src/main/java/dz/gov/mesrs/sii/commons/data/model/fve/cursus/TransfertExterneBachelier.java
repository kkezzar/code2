...
/**
 * Vue sur les demandes de transfert externes entrantes par type de bachelier
 * (nouveau/ancien)
 * 
 * @author Mounir.MESSAOUDI
 */
@Entity
@NamedQuery(name = "TransfertExterneBachelier.findAll", query = "SELECT t FROM TransfertExterneBachelier t")
@Table(name = "transfert_externe_bachelier", schema = "cursus")
public class TransfertExterneBachelier implements Serializable {
	...
	public TransfertExterneBachelier() {
	}
