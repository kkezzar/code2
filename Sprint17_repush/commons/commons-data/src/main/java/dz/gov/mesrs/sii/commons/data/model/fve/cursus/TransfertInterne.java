 ...
 */
@Entity
@NamedQuery(name = "TransfertInterne.findAll", query = "SELECT t FROM TransfertInterne t")
@Table(name = "transfert_interne", schema = "cursus")
public class TransfertInterne implements Serializable {
