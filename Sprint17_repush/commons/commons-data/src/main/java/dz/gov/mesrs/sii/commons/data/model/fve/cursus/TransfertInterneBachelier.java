...
/**
 * Vue sur les demandes de transfert interne par type de bachelier (nouveau/ancien)
 * 
 * @author Mounir.MESSAOUDI
 */
@Entity
@Cache(usage=CacheConcurrencyStrategy.NONE)
@NamedQuery(name = "TransfertInterneBachelier.findAll", query = "SELECT t FROM TransfertInterne t")
@Table(name = "transfert_interne_bachelier", schema = "cursus")
public class TransfertInterneBachelier implements Serializable {
	...
	public TransfertInterneBachelier() {
	}
