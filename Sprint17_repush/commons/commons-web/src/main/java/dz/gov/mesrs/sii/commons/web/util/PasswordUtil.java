...
/**
 * TODO remove in commons-web project
 * 
 * @author abelaid
 * 
 */
public class PasswordUtil {
	...
	// Si vous ne souhaitez pas utiliser la crypto Cypher, vous pouvez utiliser
	// un code plus simple :
	...
	public static void main(String[] arg) {
		...
		try {
			String crypted = encryptAES(password);// encrypt(password,
													// PasswordUtil.KEY);
			log.info(crypted);
			String decrypted = decryptAES(crypted);// decrypt(crypted,
													// PasswordUtil.KEY);
			log.info(decrypted);
