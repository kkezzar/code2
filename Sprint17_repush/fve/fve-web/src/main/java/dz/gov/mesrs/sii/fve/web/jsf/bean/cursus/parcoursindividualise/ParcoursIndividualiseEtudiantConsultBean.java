 ...
 */
@ManagedBean(name = "parcoursIndividualiseEtudiantConsultBean")
@ViewScoped
public class ParcoursIndividualiseEtudiantConsultBean implements Serializable {
	...
	private static final Log log = LogFactory.getLog(ParcoursIndividualiseEtudiantConsultBean.class);
	 ...
	 * @author BELDI Jamel on : 15 juil. 2014 10:03:05
	 */
	public ParcoursIndividualiseEtudiantConsultBean() {
		super();
	...
	public void init() {
		...
		if (listDossierEtudiants != null && !listDossierEtudiants.isEmpty()) {
			...
			searchDto.setNumeroMatricule(_dossierEtudiantDto.getNumeroMatricule());
	...
	/**
	 * [ParcoursIndividualiseValidateBean.loadParcoursIndividualiseToValidate]
	 * Method
	 * 
	...
	public void onRowSelect(SelectEvent event) {
		FacesMessage msg = new FacesMessage();
		ParcoursIndividualiseDto _parcours = ((ParcoursIndividualiseDto) event.getObject());
		initDetail();
		try {
			loadParcoursIndividualise(_parcours.getId().intValue());
			dossierInscriptionAdministrativeDto = loadDossierInscription(_parcours
					.getDossierInscriptionAdministrativeId().intValue());
			calculCredits();
		} catch (Exception e) {
	...
	private void loadParcoursIndividualise(int id) {
		...
		// .findById(id);
		// ParcoursIndividualiseMatiereDto _parcours =
		// parcoursIndividualiseMatiereList.get(0);
		...
		// situationService.findByIdSituationEntite(_parcours.getSituationId());
	...
	private DossierInscriptionAdministrativeDto loadDossierInscription(int id) throws Exception {
		...
		if (_dossierInscriptionAdministrativeDto.getRefCodeSpecialite() != null) {
			RefSpecialiteLmdDto _specialite = refSpecialiteLmdService
					.findByIdentifiant(_dossierInscriptionAdministrativeDto.getRefCodeSpecialite());
			if (_specialite != null) {
				_dossierInscriptionAdministrativeDto.setRefLibelleSpecialite(_specialite.getLlSpecialite());
				_dossierInscriptionAdministrativeDto.setRefLibelleSpecialiteArabe(_specialite.getLlSpecialiteArabe());
			}
		}
		...
		if (_dossierInscriptionAdministrativeDto.getRefCodeFiliere() != null) {
			RefFiliereLmdDto _filiere = refFiliereLmdService.findByIdentifiant(_dossierInscriptionAdministrativeDto
					.getRefCodeFiliere());
			if (_filiere != null) {
				_dossierInscriptionAdministrativeDto.setRefLibelleFiliere(_filiere.getLlFiliere());
				_dossierInscriptionAdministrativeDto.setRefLibelleFiliereArabe(_filiere.getLlFiliereArabe());
			}
		}
		...
		if (_dossierInscriptionAdministrativeDto.getRefCodeDomaine() != null) {
			RefDomaineLMDDto _domaine = refDomaineLMDService.findByIdentifiant(_dossierInscriptionAdministrativeDto
					.getRefCodeDomaine());
			if (_domaine != null) {
				_dossierInscriptionAdministrativeDto.setRefLibelleDomaine(_domaine.getLlDomaine());
				_dossierInscriptionAdministrativeDto.setRefLibelleDomaineArabe(_domaine.getLlDomaineArabe());
			}
		}
		...
		if (_dossierInscriptionAdministrativeDto.getRefCodeCycle() != null) {
			...
			if (_cycle != null) {
				_dossierInscriptionAdministrativeDto.setRefLibelleCycle(_cycle.getLibelleLongFr());
			}
		}
		if (_dossierInscriptionAdministrativeDto.getRefCodeNiveau() != null) {
			...
			if (_niveau != null) {
				_dossierInscriptionAdministrativeDto.setRefLibelleNiveau(_niveau.getLibelleLongFr());
				_dossierInscriptionAdministrativeDto.setRefLibelleNiveauArabe(_niveau.getLibelleLongAr());
			}
		}
		...
		if (_dossierInscriptionAdministrativeDto.getRefEtablissementId() != null) {
			RefEtablissementDto _refEtablissementDto = refEtablissementService
					.findById(_dossierInscriptionAdministrativeDto.getRefEtablissementId());
			if (_refEtablissementDto != null) {
				_dossierInscriptionAdministrativeDto.setLlEtablissementArabe(_refEtablissementDto
						.getLlEtablissementArabe());
				_dossierInscriptionAdministrativeDto.setLlEtablissementLatin(_refEtablissementDto
						.getLlEtablissementLatin());
			}
		}
		// if (dossierInscriptionAdministrativeDto.getNin() != null) {
		RefIndividuDto _refIndividuDto = refIndividuService.findByIdentifiant(_dossierInscriptionAdministrativeDto
				.getNin());
	...
	public void loadOffreFormationOuverte() {
		...
		try {
			...
			List<OuvertureOffreFormationDto> list = ouvertureOffreFormationService.findAdvanced(searchDto);
			for (OuvertureOffreFormationDto ouvertureOffreFormationDto : list) {
				OffreFormationDto offreFormationDto = offreFormationService.findById(ouvertureOffreFormationDto
						.getOffreFormationId());
				SelectItem selectItem = new SelectItem(ouvertureOffreFormationDto.getId(),
						offreFormationDto.getLibelleLongFr());
	 ...
	 */
	public void setParcoursIndividualiseList(List<ParcoursIndividualiseDto> parcoursIndividualiseList) {
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.loginBean] Getter
	 * 
	 * @author BELDI Jamel on : 7 sept. 2014 16:19:43
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.loginBean] Setter
	 * 
	 * @author BELDI Jamel on : 7 sept. 2014 16:19:43
	 * @param loginBean
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.periodeDto] Getter
	 * 
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.nomenclatureService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.nomenclatureService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refIndividuService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refIndividuService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refSpecialiteLmdService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refSpecialiteLmdService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refFiliereLmdService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refFiliereLmdService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refDomaineLMDService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refDomaineLMDService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:12:28
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refEtablissementService] Getter
	 * 
	 * @author Rafik on : 27 nov. 2014 13:46:47
	...
	/**
	 * [ParcoursIndividualiseEtudiantConsultBean.refEtablissementService] Setter
	 * 
	 * @author Rafik on : 27 nov. 2014 13:46:47
