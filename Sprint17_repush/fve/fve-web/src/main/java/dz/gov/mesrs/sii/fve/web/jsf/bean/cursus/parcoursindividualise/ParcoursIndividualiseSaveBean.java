 ...
 * @author BELDI Jamel on : 15 juil. 2014 10:03:05
 */
@ManagedBean(name = "parcoursIndividualiseSaveBean")
@ViewScoped
public class ParcoursIndividualiseSaveBean implements Serializable {
	...
	private static final Log log = LogFactory.getLog(ParcoursIndividualiseSaveBean.class);
	 ...
	 * @author BELDI Jamel on : 15 juil. 2014 10:03:05
	 */
	public ParcoursIndividualiseSaveBean() {
		super();
	...
	/**
	 * 
	 * [ParcoursIndividualiseSaveBean.initDetail] Method
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 11:36:49
	 */
	 ...
	 */
	/*
	 * public void loadPeriodes() { try { List<PeriodeDto> list =
	 * periodeService.findAll(); periodeList = new ArrayList<SelectItem>(); for
	 * (PeriodeDto periode : list) { SelectItem item = new
	 * SelectItem(periode.getId(), periode.getLibelleLongLt());
	 * periodeList.add(item); } } catch (Exception e) {
	 * 
	 * } }
	 */

	public void loadPeriodes(int levelId) {
		try {
			List<PeriodeDto> list = periodeService.findByLevelId(levelId);
	...
	/**
	 * 
	 * [ParcoursIndividualiseSaveBean.onPeriodeChanged] Method
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 10:51:57
	 */
	public void onPeriodeChanged() {
		FacesMessage msg = new FacesMessage();
		try {
			loadParcoursIndividualise();
			calculCredits();
		} catch (Exception e) {
			dossierInscriptionAdministrativeDto = new DossierInscriptionAdministrativeDto();
			msg.setSeverity(FacesMessage.SEVERITY_ERROR);
	...
	/**
	 * 
	 * [ParcoursIndividualiseSaveBean.loadParcoursIndividualise] Method
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 10:45:12
	 */
	private void loadParcoursIndividualise() {
		// TODO
		initDetail();
		if (dossierInscriptionAdministrativeDto != null
				&& dossierInscriptionAdministrativeDto.getOffreFormationId() != null
				&& dossierInscriptionAdministrativeDto.getOffreFormationId() != 0 && periodeDto != null
				&& periodeDto.getId() != 0) {
			// parcoursIndividualiseMatiereList = parcoursIndividualiseService
			// .findByIdInscriptionAdministrativeAndPeriode(dossierInscriptionAdministrativeDto.getId(),periodeDto.getId());
			ParcoursIndividualiseDto _parcoursIndividualiseDto = parcoursIndividualiseService
					.findByIdInscriptionAdministrativeAndPeriode(dossierInscriptionAdministrativeDto.getId(),
							periodeDto.getId());
			...
			if (parcoursIndividualiseMatiereList == null || parcoursIndividualiseMatiereList.isEmpty()) {
				...
				List<RattachementMcDto> _rattachements = rattachementMcService.findByOffreFormationAndPeriode(
						dossierInscriptionAdministrativeDto.getOffreFormationId(), periodeDto.getId());
				if (_rattachements != null && !_rattachements.isEmpty()) {
					...
					for (RattachementMcDto rattachementMcDto : _rattachements) {
						...
						parcoursIndividualiseMatiereDto
								.setDossierInscriptionAdministrativeId(dossierInscriptionAdministrativeDto.getId());
	...
	private void loadDossierInscription() throws Exception {
		...
		if (listDossierEtudiants != null && !listDossierEtudiants.isEmpty()) {
			...
			for (DossierEtudiantDto dossierEtudiantDto : listDossierEtudiants) {
				if (dossierEtudiantDto.getAnneeBac() != null
						&& Integer.valueOf(dossierEtudiantDto.getAnneeBac().trim().substring(0, 4)) > Integer
								.valueOf(_dossierEtudiantDto.getAnneeBac().trim().substring(0, 4))) {
					_dossierEtudiantDto = dossierEtudiantDto;
				}
			}
			...
			if (dossierInscriptionAdministrativeDto.getNiveauId() != null
					&& dossierInscriptionAdministrativeDto.getNiveauId() != 0) {
				loadPeriodes(dossierInscriptionAdministrativeDto.getNiveauId());
			}
			/*
			 * // Initialisation du cycle & niveau if
			 * (dossierInscriptionAdministrativeDto.getRefCodeCycle() != null) {
			 * NomenclatureDto _cycle = nomenclatureWSProxy.findByCode(
			 * Const.LMD_CYCLE,
			 * dossierInscriptionAdministrativeDto.getRefCodeCycle()); if
			 * (_cycle != null) { dossierInscriptionAdministrativeDto
			 * .setRefLibelleCycle(_cycle.getLibelleLongFr()); } }
			 * 
			 * if (dossierInscriptionAdministrativeDto.getRefCodeNiveau() !=
			 * null) {
			 * 
			 * NomenclatureDto _niveau = nomenclatureWSProxy.findByCode(
			 * Const.LMD_PALIER,
			 * dossierInscriptionAdministrativeDto.getRefCodeNiveau()); if
			 * (_niveau != null) { dossierInscriptionAdministrativeDto
			...
			if (dossierInscriptionAdministrativeDto.getRefCodeTypeInscription() != null) {
				NomenclatureDto _ncDto = nomenclatureService.findByCode("Const.LMD_TYPE_DOSSIER_INSCRIPTION",
						dossierInscriptionAdministrativeDto.getRefCodeTypeInscription());
				// referentielHelper
				// .getNomenclatureItemValue(
				// "Const.LMD_TYPE_DOSSIER_INSCRIPTION",
				// dossierInscriptionAdministrativeDto
				// .getRefCodeTypeInscription())
				if (_ncDto != null)
	...
	private void calculCredits() {
		if (parcoursIndividualiseMatiereList != null && !parcoursIndividualiseMatiereList.isEmpty()) {
			...
			for (ParcoursIndividualiseMatiereDto parcoursIndividualiseMatiereDto : parcoursIndividualiseMatiereList) {
				...
				if (parcoursIndividualiseMatiereDto.getOptionnelle() == null
						|| parcoursIndividualiseMatiereDto.getOptionnelle() != true
	...
	public void saveParcoursIndividualise() {
		...
		try {
			...
			if (creditsDemande != creditsAtteint) {
			...
			parcoursIndividualiseMatiereList.get(0).setSituationId(
					situationService.findBySituationEntiteByCodeSituation(
							...
							.getId());
			parcoursIndividualiseMatiereList.get(0).setIdPeriode(periodeDto.getId());
	...
	public void onChoixChanged(AjaxBehaviorEvent event) {
		...
		// if(credit != null && !credit.trim().equals("null") &&
		// !credit.trim().equals("")){
		//
	...
	/**
	 * [ParcoursIndividualiseSaveBean.periodeDto] Getter
	 * 
	 * @author BELDI Jamel on : 8 sept. 2014 17:57:32
	...
	/**
	 * [ParcoursIndividualiseSaveBean.periodeDto] Setter
	 * 
	 * @author BELDI Jamel on : 8 sept. 2014 17:57:32
	 * @param periodeDto
	...
	/**
	 * [ParcoursIndividualiseSaveBean.renderedDetail] Getter
	 * 
	 * @author BELDI Jamel on : 8 sept. 2014 17:57:32
	 * @return the renderedDetail
	 */
	...
	/**
	 * [ParcoursIndividualiseSaveBean.renderedDetail] Setter
	 * 
	 * @author BELDI Jamel on : 8 sept. 2014 17:57:32
	 * @param renderedDetail
	 *            the renderedDetail to set
	 */
	...
	/**
	 * [ParcoursIndividualiseSaveBean.periodeList] Getter
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 10:18:14
	...
	/**
	 * [ParcoursIndividualiseSaveBean.periodeList] Setter
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 10:18:14
	 * @param periodeList
	...
	/**
	 * [ParcoursIndividualiseSaveBean.periodeService] Getter
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 10:18:14
	...
	/**
	 * [ParcoursIndividualiseSaveBean.periodeService] Setter
	 * 
	 * @author BELDI Jamel on : 9 sept. 2014 10:18:14
	...
	/**
	 * [ParcoursIndividualiseSaveBean.nomenclatureService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.nomenclatureService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refIndividuService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refIndividuService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refSpecialiteLmdService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refSpecialiteLmdService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refFiliereLmdService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refFiliereLmdService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refDomaineLMDService] Getter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refDomaineLMDService] Setter
	 * 
	 * @author rlaib on : 20 nov. 2014 16:14:35
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refEtablissementService] Getter
	 * 
	 * @author Rafik on : 27 nov. 2014 13:46:36
	...
	/**
	 * [ParcoursIndividualiseSaveBean.refEtablissementService] Setter
	 * 
	 * @author Rafik on : 27 nov. 2014 13:46:36
