 ...
 */
/**
 * @author BELDI Jamel  on : 11 ao�t 2014  11:53:37
 */
/**
 * @author BELDI Jamel  on : 11 ao�t 2014  11:53:38
 */
/**
 * @author BELDI Jamel  on : 11 ao�t 2014  11:53:42
 */
/**
 * @author BELDI Jamel  on : 11 ao�t 2014  14:41:09
 */
@ManagedBean(name = "parcoursIndividualiseValidateBean")
@ViewScoped
public class ParcoursIndividualiseValidateBean implements Serializable {
	...
	private static final Log log = LogFactory
			.getLog(ParcoursIndividualiseValidateBean.class);
	 ...
	 * @author BELDI Jamel on : 15 juil. 2014 10:03:05
	 */
	public ParcoursIndividualiseValidateBean() {
		super();
	...
	public void init() {
			...
			loadParcoursIndividualiseToValidate();
			initDetail();
			/**
			parcoursIndividualiseMatiereList = new ArrayList<>();
			situation = null;
			creditsDemande = 0;
			creditsAtteint = 0;
	 ...
	 */
	private void loadParcoursIndividualiseToValidate(){
		FacesMessage msg = new FacesMessage();
		try {
		parcoursIndividualiseList = new ArrayList<ParcoursIndividualiseDto>();	
		List<ParcoursIndividualiseDto> _parcoursIndividualiseList = parcoursIndividualiseService.findParcourstoValidate(sessionBean.getCodeEtablissement());
	...
	/**
	 * [ParcoursIndividualiseValidateBean.onRowEdit] Method 
	 * @author BELDI Jamel  on : 11 ao�t 2014  11:53:33
	 * @param event
	 */
	public void onRowEdit(RowEditEvent event) {
		ParcoursIndividualiseMatiereDto element = ((ParcoursIndividualiseMatiereDto) event.getObject());
		element.setDateRemarque(new Date());		
		parcoursIndividualiseService.updateParcoursIndividualiseMatiere(element);
		
    }
     
    /**
     * [ParcoursIndividualiseValidateBean.onRowCancel] Method 
     * @author BELDI Jamel  on : 11 ao�t 2014  11:53:45
     * @param event
     */
   ...
   /**
    *   
    * [ParcoursIndividualiseValidateBean.valider] Method 
    * @author BELDI Jamel  on : 11 ao�t 2014  14:41:42
    */
	public void valider() {
		FacesMessage msg = new FacesMessage();
		try {
			...
			boolean _result = parcoursIndividualiseService.updateSituation(
					parcoursIndividualiseMatiereList.get(0)
							.getParcoursIndividualiseId(),
					situationService.findBySituationEntiteByCodeSituation(
							UtilConstants.ENTITE_PARCOURS_INDIVIDUALISE_CODE,
							UtilConstants.SITUTAION_VALIDEE_CODE).getId());
			if (_result) {
               
				msg.setSeverity(FacesMessage.SEVERITY_INFO);
				String summary = "parcours_individualise_success_validation_msg";
	...
	/**
	 * 
	 * [ParcoursIndividualiseValidateBean.renvoyer] Method 
	 * @author BELDI Jamel  on : 12 ao�t 2014  12:21:42
	 */
		public void renvoyer() {
			...
			try {
				...
				boolean _result = parcoursIndividualiseService.updateSituation(
						...
						situationService.findBySituationEntiteByCodeSituation(
								UtilConstants.ENTITE_PARCOURS_INDIVIDUALISE_CODE,
								UtilConstants.SITUTAION_A_REFORMULER_CODE).getId());
				if (_result) {
	               
					msg.setSeverity(FacesMessage.SEVERITY_INFO);
					String summary = "parcours_individualise_success_renvoi_msg";
					msg.setSummary(bundleCommon.getString("msg_success") + ": "
							+ parcoursIndividualiseBundle.getString(summary));
					init();
					FacesContext.getCurrentInstance().addMessage(null, msg);
	...
	/**
	 * [ParcoursIndividualiseValidateBean.periodeDto] Getter 
	 * @author BELDI Jamel on : 8 sept. 2014  15:31:18
	...
	/**
	 * [ParcoursIndividualiseValidateBean.periodeDto] Setter 
	 * @author BELDI Jamel on : 8 sept. 2014  15:31:18
	...
	/**
	 * [ParcoursIndividualiseValidateBean.nomenclatureService] Getter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.nomenclatureService] Setter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refIndividuService] Getter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refIndividuService] Setter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refSpecialiteLmdService] Getter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refSpecialiteLmdService] Setter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refFiliereLmdService] Getter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refFiliereLmdService] Setter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refDomaineLMDService] Getter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refDomaineLMDService] Setter 
	 * @author rlaib on : 20 nov. 2014  16:18:28
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refEtablissementService] Getter 
	 * @author Rafik on : 27 nov. 2014  13:46:22
	...
	/**
	 * [ParcoursIndividualiseValidateBean.refEtablissementService] Setter 
	 * @author Rafik on : 27 nov. 2014  13:46:22
