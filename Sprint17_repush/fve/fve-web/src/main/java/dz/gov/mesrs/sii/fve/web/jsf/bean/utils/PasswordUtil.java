 ...
 * @author BELDI Jamel on : 25 fevr. 2014  18:36:36
 */
...
/**
 * @author BELDI Jamel  on : 25 fevr. 2014  18:36:36
 * permettant de crypter ou de decrypter des String Java et
 *  ce en utilisant une cle de cryptage ainsi que les outils du package Cypher
 */
...
public class PasswordUtil {
	 ...
	 * @author BELDI Jamel  on : 25 fevr. 2014  18:39:20
	 * @param password
	 * @param key
	 * @return
	 * @throws Exception 
	 ...
	 * @author BELDI Jamel  on : 25 fevr. 2014  18:39:26
	 * @param password
	 * @param key
	 * @return
	 * @throws Exception 
	...
	//Si vous ne souhaitez pas utiliser la crypto Cypher, vous pouvez utiliser un code plus simple :
		    ...
		    /**
		     * [PasswordUtil.encrypt] Method 
		     * @author BELDI Jamel  on : 25 fevr. 2014  18:43:50
		     * @param password
		     * @return
		     */
		    ...
		    /**
		     * [PasswordUtil.decrypt] Method 
		     * @author BELDI Jamel  on : 25 fevr. 2014  18:44:06
		     * @param password
		     * @return
		     */
