 ...
 */
@ManagedBean(name = "budgetFinalBean")
@ViewScoped
public class BudgetFinalMBean extends BaseBean {
	...
	private List<DetailsProjetBudgetDto> listDetailsBudgetDepenses;
	private List<DetailsProjetBudgetDto> listDetailsBudgetRecettes;
	...
	public void saveAction() {
		try {
			...
			for (DetailsProjetBudgetDto details : listDetailsBudgetRecettes)
				serviceLocator.getDetailsProjetBudgetService().save(details);
			for (DetailsProjetBudgetDto details : listDetailsBudgetDepenses)
				serviceLocator.getDetailsProjetBudgetService().save(details);
	...
	public void buildListDetailsProjet(ProjetBudgetDto projetBudget) {
		listDetailsBudgetDepenses = new ArrayList<DetailsProjetBudgetDto>();
		listDetailsBudgetRecettes = new ArrayList<DetailsProjetBudgetDto>();

		List<DetailsProjetBudgetDto> list = new ArrayList<DetailsProjetBudgetDto>();
		 if (projetBudgetDto != null) {
		 list = projetBudgetDto.getDetailsProjetBudgets();
		 if (list != null && list.size() > 0) {
		 for (DetailsProjetBudgetDto dto : list) {
		 
		
			 if (dto.getChapitre() != null
			 && dto.getChapitre().isRecetteType())
			 listDetailsBudgetRecettes.add(dto);
		 else
			 listDetailsBudgetDepenses.add(dto);
		 }
	...
	public void transferAction() {
		...
		if (listDetailsBudgetDepenses != null) {
			for (DetailsProjetBudgetDto detail : listDetailsBudgetDepenses)
				detail.setMontantFinal(detail.getMontantBesoins());
		}
		if (listDetailsBudgetRecettes != null) {
			for (DetailsProjetBudgetDto detail : listDetailsBudgetRecettes)
				detail.setMontantFinal(detail.getMontantBesoins());
		}
	}
	 ...
	 */
	public List<DetailsProjetBudgetDto> getListDetailsBudgetDepenses() {
	 ...
	 */
	public void setListDetailsBudgetDepenses(List<DetailsProjetBudgetDto> listDetailsBudgetDepenses) {
	 ...
	 */
	public List<DetailsProjetBudgetDto> getListDetailsBudgetRecettes() {
	 ...
	 */
	public void setListDetailsBudgetRecettes(List<DetailsProjetBudgetDto> listDetailsBudgetRecettes) {
	...
	/**
	 * @param projetBudgetHistory the projetBudgetHistory to set
	 */
	public void setProjetBudgetHistory(
			List<SituationEntiteOccurrenceDto> projetBudgetHistory) {
