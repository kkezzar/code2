...
/**
 * Demander la prepration du budget au niveau central
 * 
 * @author MESSOAUDI MOUNIR (MESRS CCM)
 * @version 1.0
 * @created 24/11/2014 18:06:31
 */
@ManagedBean(name = "demanderPreparationBudgetCentralBean")
@ViewScoped
public class DemanderPreparationBudgetCentralMBean extends BaseBean {
	...
	public DemanderPreparationBudgetCentralMBean() {
