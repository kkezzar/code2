...
/**
 * Enregistre la date d'envoi au mesrs
 * 
 * @author MESSOAUDI MOUNIR (MESRS CCM)
 * @version 1.0
 * @created 05/01/2015 18:06:31
 */
@ManagedBean(name = "ficheBesoinsEnvoiMESRSBean")
@ViewScoped
public class FicheBesoinsEnvoiMESRSMBean extends BaseBean {
	...
	public FicheBesoinsEnvoiMESRSMBean() {
	}
	...
	public void validateAction() {
		ficheBesoinsDto = serviceLocator.getFicheBesoinsService().envoyerFicheBesoinsMESRS(ficheBesoinsDto);
		isCrud = false;
