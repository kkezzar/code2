...
@ManagedBean(name = "avancementEchelonConsultMBean")
@ViewScoped
/**
 * 
 * @author SLIMANE Ramdane  on : 04 dec. 2014  14:51:27
 */
public class AvancementEchelonConsultMBean extends BaseBean{
	/**
	 * serialVersionUID 
	...
	public AvancementEchelonConsultMBean() {
	...
	public void init()  {	
		...
		situationEntiteDto = this.serviceLocator.getSituationService().findBySituationEntiteByCodeSituation(UtilConstants.ENTITE_PROPOSITION_AVANCEMENT_CODE,UtilConstants.SITUATION_VALIDEE_CODE);
	...
	public void onCreateListEmployeProposable() {
		...
		try {
			if(valeurMinEchelom != null)
				listDetailPropostionAvancementDto=serviceLocator.getCarriereService().agentProposableEchelon(Integer.valueOf(propostionAvancementDto.getMoisDto().getCode()), propostionAvancementDto.getAnnee(),Integer.valueOf(valeurMinEchelom), formatter.parse("2017-01-01"), propostionAvancementSearchDto,refEtablissementDto.getId(),null);
