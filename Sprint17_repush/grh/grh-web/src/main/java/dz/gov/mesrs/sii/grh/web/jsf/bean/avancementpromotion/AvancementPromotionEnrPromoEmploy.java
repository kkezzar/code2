...
@ManagedBean(name = "avancementPromotionEnrPromoEmploy")
@ViewScoped
/**
 * 
 * @author SLIMANE Ramdane  on : 04 dec. 2014  14:51:27
 */
public class AvancementPromotionEnrPromoEmploy extends BaseBean{
	/**
	 * serialVersionUID 
	...
	public AvancementPromotionEnrPromoEmploy() {
	...
	public void onCreateListEmployeProposable() {			
		...
		listDetailPropostionAvancementDto=new ArrayList<EmployeProposeDto>();	
		try {			
			listDetailPropostionAvancementDto=serviceLocator.getCarriereService().agentProposableEchelon(Integer.valueOf(propostionAvancementDto.getMoisDto().getCode())
					, propostionAvancementDto.getAnnee(),Integer.valueOf("1"), formatter.parse("2017-01-01"), propostionAvancementSearchDto,refEtablissementDto.getId(),null);
