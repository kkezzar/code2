...
@ManagedBean(name = "candidatEmployeValidationMBean")
@ViewScoped
/**
 * 
 * @author BELDI Jamel  on : 14 déc. 2014  09:43:55
 */
public class CandidatEmployeValidationMBean extends BaseBean {
	...
	public CandidatEmployeValidationMBean() {
	...
	public void onValidate() {
		try {
			beforeSave();
			this.serviceLocator.getCandidatEmployeService().validateAll(
					this.listCandidatEmployeDtos);
			afterSave();
