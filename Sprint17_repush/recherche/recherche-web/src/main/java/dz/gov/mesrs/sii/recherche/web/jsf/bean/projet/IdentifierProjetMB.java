 ...
 * @author rlaib  on : 16 d�c. 2014  16:06:14
 */
@ManagedBean(name = "identifierProjetMB")
@ViewScoped
public class IdentifierProjetMB extends BaseBean {
...
private void initListStructure() {
	...
	private Integer selectedStepId,selectedMotcleId,selectedIndicateurId,selectedTypeAppreciationId;//supp
