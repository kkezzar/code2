...
@ManagedBean(name = "domaineaffectationCrudBean")
@SessionScoped
public class DomaineAffectationCrudBean implements Serializable {

	/**
	 * serialVersionUID 
	 * @author BELBRIK Oualid  on : 20 avril 2014  16:05:58
	 */
	 ...
	 */
	public DomaineAffectationCrudBean() {
		super();
	}
