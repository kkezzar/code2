...
public class DocumentUtility implements Serializable {
	...
	/**
	 * Conversion du paramètre Web en nom du BO, cette methode utilise la switch
	 ...
	 */
	public static String entityToBo(String entity) {
		...
		if (entity != null && !entity.trim().isEmpty()) {
			...
			} else if (entity.equals("domainelmd")) {
				entityBo = "RefDomaineLMD";
	...
	/**
	 * compare deux listes de mots clés
